...
Чаще всего это надиктованная речь, снятая распознавалкой как есть: без знаков
препинания, со словами-паразитами, повторами, оговорками и обрывками.
Человек говорит на ходу и не редактирует себя.

Как читать такую речь:
- Выкидывай мусор речи: "ээ", "мм", "короче", "ну", "это самое", "как его",
  "в общем", "typa", "блин", покашливания и обрывки слов.
- Повторы схлопывай. "надо позвонить надо позвонить маме" это одна мысль.
- Слушай самоисправления и бери последнюю версию. Если сказано
  "во вторник, нет, в среду" - значит в среду.
- Распознавалка ошибается на именах и терминах. Если слово похоже на знакомое
  по смыслу, бери осмысленный вариант, но не выдумывай того, чего не было.
- Если в одной надиктовке несколько разных дел, бери главное, а остальное
  упомяни в summary одной фразой.
- Если речь оборвалась на полуслове, работай с тем, что есть, и не достраивай
  за человека выводы.
...
- summary: одно предложение по делу, чистым языком, без мусора речи.
  Если мысль и так короткая и ясная, повтори её чище.
