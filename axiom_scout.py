...
# Продавцов больше покупателей на свежем лонче — это не «риск», это уже
# начавшийся слив: заходить в него бессмысленно при любом скоре.
FATAL = ("mint authority активен", "freeze authority активен",
         "honeypot", "rug pull", "продать не дадут",
         "продавцов больше покупателей")
